...
| Action | Quand | Gate |
|--------|-------|------|
| Conduire les sessions d'interviews utilisateurs | Après `/write-interview-guide` + `/write-discovery-interview` | Gate -1 |
| Valider le research complet (stratégique + utilisateur + discovery) | Après les 3 phases research | Gate -1 |
...
| `ux-researcher` | Discovery interviews (structure + guide) | ⚙️ Semi-auto (Product Designer conduit les sessions) |

### Spécification fonctionnelle (BA + PO)
| Délégué à | Action | Niveau d'automatisation |
|-----------|--------|------------------------|
| `business-analyst` | Cadrage (10 questions — 6 fonctionnelles + 4 contractuelles) | ⚙️ Semi-auto (Product Designer répond aux questions) |
...
| Research utilisateur | Conduit les sessions — valide les insights (Gate -1) |
| Discovery interviews | Conduit les sessions — valide les insights (Gate -1) |
| Cadrage | Répond aux 10 questions, valide le résumé, définit l'OS de base (Gate 0) |
