...
<!-- ✅ NOUVEAU [AI] : liaison avec design-tokens.md — contexte IA et design system -->
## Fichiers de référence du projet

| Fichier | Rôle | Audience | Géré par |
|---------|------|----------|----------|
| `design.md` *(ce fichier)* | Conventions de process et gouvernance | Équipe (BA, UX, UI, PO, Dev) | Tout le projet |
| `design-system/design-tokens.md` | Tokens visuels — couleurs, typo, spacing, composants | IA (Stitch, Claude) + Dev | Design System Manager |

> **Règle** : toute valeur visuelle (couleur, taille, radius…) est définie dans `design-tokens.md`. Ce fichier ne contient pas de valeurs — il contient les règles d'usage de ces valeurs.
...
├── design-tokens.md           ← Tokens visuels — format Stitch / IA-ready
├── tokens/
├── components/
└── guidelines/
```
...
> Les valeurs des tokens sont définies dans [`design-system/design-tokens.md`](../design-system/design-tokens.md).
...
## Liaison docs ↔ Figma — règle obligatoire
