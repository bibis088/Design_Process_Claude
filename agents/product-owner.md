...
1. Feature tickets avec MoSCoW et KPIs
2. User stories avec CA (neutralité visuelle, gestion des erreurs 3 colonnes, accessibilité, advisory, 1 US à la fois)
3. Plan de tagage (tracking plan) — KPIs → événements analytics mappés sur les écrans Figma
4. Révision du plan de tagage après la phase UI (post Gate 8)
5. Documentation fonctionnelle complète (EPIC → frames Figma)
6. Livrables client selon le type contractuel (7 types disponibles)
7. Release notes App Store + Play Store
