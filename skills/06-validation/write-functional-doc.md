...
- [ ] `EPIC.md` disponible et Approved
- [ ] `design/[feature-slug]/` complet — SCREENS-MAP + user-flows + specs écrans
- [ ] `FLUX-###` disponibles — matrice EPIC→flux→écran
- [ ] `PERSONA-###` Approved — doc inclut les profils utilisateurs
- [ ] `specs/[epic-slug]/figma-urls.md` disponible — URLs directes des frames
...
**User flow Figma :** [URL page `Userflow`]
