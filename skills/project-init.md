...
```
Bonjour. Avant de démarrer le process, j'ai besoin de quelques informations.
...
QUESTION 2 — Vos choix pour chaque groupe d'étapes

Le process est organisé en 6 groupes. Pour chaque groupe, indiquez :
...
│ Competitive analysis, sector watch, benchmark, discovery        │
│ Votre choix : [ 🤖 Auto / ✋ Manuel / 🔀 Mixte ]               │
├─────────────────────────────────────────────────────────────────┤
│ GROUPE 2 — Cadrage et Spécification                             │
│ Cadrage, personas, flux, règles métier, US, priorisation        │
│ Votre choix : [ 🤖 Auto / ✋ Manuel / 🔀 Mixte ]               │
├─────────────────────────────────────────────────────────────────┤
│ GROUPE 3 — Setup Figma                                          │
│ Structure fichiers, tokens, grilles, bibliothèque, permissions  │
│ Votre choix : [ 🤖 Auto / ✋ Manuel / 🔀 Mixte ]               │
├─────────────────────────────────────────────────────────────────┤
│ GROUPE 4 — UX Design                                            │
│ Navigation map, user flows, specs écrans, accessibilité         │
│ Votre choix : [ 🤖 Auto / ✋ Manuel / 🔀 Mixte ]               │
├─────────────────────────────────────────────────────────────────┤
│ GROUPE 5 — UI Design                                            │
│ Composants, direction artistique, écrans, prototype             │
│ Votre choix : [ 🤖 Auto / ✋ Manuel / 🔀 Mixte ]               │
│ Note : la direction artistique est toujours manuelle            │
├─────────────────────────────────────────────────────────────────┤
│ GROUPE 6 — Validation et Livraison                              │
│ Tests utilisateur, plan de tagage, doc fonctionnelle, handoff   │
│ Votre choix : [ 🤖 Auto / ✋ Manuel / 🔀 Mixte ]               │
└─────────────────────────────────────────────────────────────────┘
...
[Vide au démarrage — mis à jour à chaque checkpoint]
```
...
- Interviews de découverte avec des utilisateurs potentiels
...
- Points de conformité légale identifiés (RGPD, accessibilité, réglementations sectorielles)
- 3 patterns UX retenus comme référence pour ce projet

### Objectifs de cette phase
1. Comprendre les besoins réels au-delà du brief client
2. Identifier les opportunités non couvertes par les concurrents
3. Établir une base de référence qualitative pour les décisions de conception

### DoD — Critères de sortie

Pour passer au Groupe 2, les éléments suivants doivent être disponibles :
- [ ] `specs/[project-slug]/research/discovery-interviews.md` — insights + vocabulaire utilisateur
- [ ] `specs/[project-slug]/research/competitive-analysis.md` — analyse de 3+ concurrents
...
Étapes concernées : [liste]
Mode configuré : [Auto / Manuel / Mixte]

Souhaitez-vous adapter ce choix avant de continuer ?

  ✅ Continuer en mode [mode actuel]
  🔄 Changer le mode pour ce groupe :
     → 🤖 Auto — les agents réalisent tout
     → ✋ Manuel — vous réalisez, les agents vérifient la DoD
     → 🔀 Mixte — on choisit étape par étape maintenant
...
**Fichier Projet**
- Pages : 🗺️ user_flows / 📱 screens / 🔧 components / 🚀 handoff / 📦 store_assets
...
- Flows visuels dans Figma (page 🗺️ user_flows)
