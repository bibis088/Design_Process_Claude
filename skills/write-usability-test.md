...
description: Produit le protocole de test d'utilisabilité et le template de rapport. Guide le Humain pour tester les maquettes UX avec de vrais utilisateurs. Exécuté par le ux-researcher après les maquettes UX.
...
- Humain (exécute — conduit les tests)
