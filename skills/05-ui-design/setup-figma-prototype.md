...
- [ ] MCP Figma connecté
- [ ] `US-###` source de chaque écran disponible
- [ ] `design/[feature-slug]/ux/user-flow-FLUX-###.md` disponible — connexions basées sur les flows

## Processus

### Étape 1 — Lire le user flow de référence

Depuis `design/[feature-slug]/ux/user-flow-FLUX-###.md` et la page `Userflow` Figma, extraire :
...
Via `use_figma`, sur la page `Work In Progress UI` :
